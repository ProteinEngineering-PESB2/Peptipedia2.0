...
from peptipedia.modules.encoding_strategies import run_fft_encoding
...
class ActivityPrediction(ConfigTool):
    ...
    def __process_encoding_stage(self):
        ...
        for id_group, group in zip(self.df_encoder.idencoding, self.df_encoder.name):
            ...
            self.dataset_encoded = pd.concat([self.dataset_encoded, group_df], axis=0)
